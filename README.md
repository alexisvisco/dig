...
```
$ glide get 'github.com/alexisvisco/dig#^1'
$ dep ensure -add "github.com/alexisvisco/dig@v1"
$ go get 'github.com/alexisvisco/dig@v1'
```
...
[doc]: https://godoc.org/github.com/alexisvisco/dig
